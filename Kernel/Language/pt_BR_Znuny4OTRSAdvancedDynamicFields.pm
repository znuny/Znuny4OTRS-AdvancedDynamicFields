...
sub Data {
	...
	# Importar / Exportar
    # Frontend
    $Self->{Translation}->{'Here you can upload a configuration file to import dynamic fields to your system. The file needs to be in .yml format as exported by dynamic field management module.'} = 
		'Aqui você pode carregar um arquivo de configuração para importar campos dinâmicos para o seu sistema. O arquivo precisa estar no formato .yml exportado pelo módulo de gerenciamento de campo dinâmico.';
    ...
    # Telas
    # Frontend    	
	$Self->{Translation}->{'You can assign elements to this Screen/Field by dragging the elements with the mouse from the left list to the right list.'} = 
	...
	$Self->{Translation}->{"Ordering the elements within the list is also possible by drag 'n' drop."} = 
		"Também é possível ordenar os elementos na lista através de arrastar e soltar.";
