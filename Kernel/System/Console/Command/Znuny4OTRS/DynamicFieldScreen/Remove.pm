...
package Kernel::System::Console::Command::Znuny4OTRS::DynamicFieldScreen::Remove;
...
sub Run {
    ...
    if ( !@DynamicFieldScreens ) {
        @DynamicFieldScreens = @{ $ConfigObject->Get('Znuny4OTRSAdvancedDynamicFields::DynamicFieldScreens') };
    }
